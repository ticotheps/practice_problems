import unittest
from insertion_sort import insertionSort, insertionSort_optimized
...
class Test(unittest.TestCase):
    ...
    def test_insertionSort_optimized(self):
        self.assertEqual(insertionSort_optimized([8, 5, 2, 9, 5, 6, 3]), [2, 3, 5, 5, 6, 8, 9])
        self.assertEqual(insertionSort_optimized([1]), [1])
        self.assertEqual(insertionSort_optimized([1, 2]), [1, 2])
        self.assertEqual(insertionSort_optimized([2, 1]), [1, 2])
        self.assertEqual(insertionSort_optimized([1, 3, 2]), [1, 2, 3])
        self.assertEqual(insertionSort_optimized([3, 1, 2]), [1, 2, 3])
        self.assertEqual(insertionSort_optimized([1, 2, 3]), [1, 2, 3])
        self.assertEqual(
            insertionSort_optimized(
                [-4, 5, 10, 8, -10, -6, -4, -2, -5, 3, 5, -4, -5, -1, 1, 6, -7, -6, -7, 8]), 
            [-10, -7, -7, -6, -6, -5, -5, -4, -4, -4, -2, -1, 1, 3, 5, 5, 6, 8, 8, 10])
        self.assertEqual(
            insertionSort_optimized(
