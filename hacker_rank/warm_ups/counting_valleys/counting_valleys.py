...
- During the last hike that took exactly "steps" steps, for ever step it was
...
Example:
    ...
    - Then, they climb out and up onta a mountain 2 units high.
...
Input Format:
    - The first line contains an integer, 'steps', the number of steps in the
    hike.
...
Explanation:
    ...
    - Therefore, the hiker enters and leaves ONE 'valley'.
"""